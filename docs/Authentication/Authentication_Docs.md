...
model Account { /* OAuth providers (future) */ }
model Session { /* Not used with JWT strategy */ }
...
NEXTAUTH_URL="https://ubcupids.com"            # Prod

# Email (Resend)
RESEND_API_KEY="re_xxxxxxxxxxxxx"
RESEND_FROM_EMAIL="UBCupids <noreply@ubcupids.com>"

# App URL (for email links)
NEXT_PUBLIC_APP_URL="http://localhost:3000"    # Dev
NEXT_PUBLIC_APP_URL="https://ubcupids.com"     # Prod
