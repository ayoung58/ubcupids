 ...
 * Options with allowCustomInput=true will show a text input when selected.
 */
    ...
    <div className="space-y-2">
      {options.map((option) => (
        <div key={option.value} className="space-y-2">
          ...
          {/* Show text input for options with allowCustomInput */}
          {option.allowCustomInput && value === option.value && (
            <input
              type="text"
              value={otherValue}
